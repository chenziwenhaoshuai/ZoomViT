...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default=r'G://imagenet', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--resume', default='output/best_checkpoint-zoom8-79.510.pth', help='resume from checkpoint')
...
def main(args):
    ...
    if args.finetune:
        ...
        try:
            ...
            print('no position encoding ckp')
